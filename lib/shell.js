import { c as joinUnc, d as parseWslUnc, f as windowsToMntPath, n as defaultDistroSync, o as isValidWslUsername, s as isWindowsPathShaped } from "./wsl-qwxCKU5O.js";
import { r as getWorkspaceUsername } from "./wsl-credentials-CV5B85rx.js";
import { i as timeoutOf, n as clampTimeout, r as deadline, t as MAX_TIMER_DELAY_MS } from "./lib-CFXc-Yau.js";
...
function assertServiceableWslConfig(config) {
	...
	if (resolved.graceMs > 2147483647) throw new Error(`wsl-shell: graceMs must be no greater than ${MAX_TIMER_DELAY_MS}`);
